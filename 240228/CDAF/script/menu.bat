...
REM **********************************************************************
%TOOL%\Menu_1628.exe %INC%\iCatchTek.xls ..\%FOLDER_HOST%\app_status\sts_menu\app_menu_tab.c english schinese french spanish german italian portuguese dutch japanese russian arabic
