...
#define SP1K_GPIO_RPT           0  /* was 12, 0 ~ 16; 0:No repeate key; 1:More frequently*/
#define SP1K_GPIO_RPT_START		100 //define the delay time to do the first repeat key
...
#define KEY_SCAN_ADC_A_VAL_IDLE		(KEY_SCAN_ADC_VAL_MIN + 0x2B7)
#else
#define KEY_SCAN_ADC_A_VAL_IDLE		(KEY_SCAN_ADC_VAL_MIN + 0x0fU)
#endif
...
#define KEY_SCAN_GPIO_VAL_RPT_START		100 				// define the delay time to do the first repeat key (5ms???━?：|??：????：????：???????：???????)

#define KEY_SCAN_ADC_VAL_RPT			1	//Key scan: 10ms
#define KEY_SCAN_ADC_VAL_RPT_START		15

#define KEY_SCAN_ZOOM_ADC_VAL_RPT_START		5
...
#else
#define SP1K_ADC_BTN_A_S1			1023//947//920 //468	/*zoom in*/	/* power */
//#define SP1K_ADC_BTN_A_S2			850//860//830 //723	/*snap*/	/* LEFT */
//#define SP1K_ADC_BTN_A_S3			1004 //872	/*zoom out*/ 	/* DOWN */
#endif

#if (_HW_SOLUTION_ == _HW_EVB_)

#define SP1K_ADC_BTN_B_S1 95   // MODE?
#define SP1K_ADC_BTN_B_S2 281  // DEL?
#define SP1K_ADC_BTN_B_S3 415  // DOWN
#define SP1K_ADC_BTN_B_S4 573  // MENU
#define SP1K_ADC_BTN_B_S5 720  // BACK
#define SP1K_ADC_BTN_B_S6 855  // UP
#define SP1K_ADC_BTN_B_S7 1023 // OK
...
#else
#define SP1K_ADC_BTN_DEV_A_S1		37
//#define SP1K_ADC_BTN_DEV_A_S2		60
//#define SP1K_ADC_BTN_DEV_A_S3		10
#endif
...
#define SP1K_ADC_BTN_DEV_B_S6		50
