...
typedef enum _PRV_SIZE
{
	...
	PRV_SIZE_5M			= (unsigned char) 0x00,  		/*	1600x1200	*/
	PRV_SIZE_8M			= (unsigned char) 0x01,			/* 	2592x1944	*/
	PRV_SIZE_12M		= (unsigned char) 0x02,			/*	3264x2448	*/
	PRV_SIZE_18M		= (unsigned char) 0x03,			/* 	2592x1944	*/
	PRV_SIZE_24M		= (unsigned char) 0x04,			/*	3264x2448	*/
	PRV_SIZE_30M		= (unsigned char) 0x05,			/* 	2592x1944	*/
	PRV_SIZE_40M		= (unsigned char) 0x06,			/*	3264x2448	*/

	PRV_SIZE_MAX		= (unsigned char) 0x07,

	
	PRV_SIZE_20M		,			/* 	2592x1944	*/
	PRV_SIZE_16M		,  		/*	1600x1200	*/
...
typedef enum _PRV_EFFECT
{
	...
	PRV_EFFECT_RED			= (unsigned char) 0x03,
	PRV_EFFECT_BLUE			= (unsigned char) 0x04,
	PRV_EFFECT_NEGATIVE		= (unsigned char) 0x05,
	PRV_EFFECT_GREEN		= (unsigned char) 0x06,
...
typedef enum _PRV_VIDEOSIZE
{
	...
	MOV_SIZE_MAX		= (unsigned char) 0x02,
...
typedef enum _LANGUAGE
{
	...
	French 				= (unsigned char) 0x02,
	Spanish 			= (unsigned char) 0x03,
	German 				= (unsigned char) 0x04,
	Italian 			= (unsigned char) 0x05,
	Portuguese 			= (unsigned char) 0x06,
	Dutch 				= (unsigned char) 0x07,
	Japanese  			= (unsigned char) 0x08,
	Russian 			= (unsigned char) 0x09,
	arabic				= (unsigned char) 0x0a,
	
	LANGUAGE_MAX		= (unsigned char) 0x0b,
