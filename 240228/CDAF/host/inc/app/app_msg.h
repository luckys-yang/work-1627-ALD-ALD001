...
typedef enum {
	...
	SP1K_MSG_UPDATE_RTCTIME = ((UINT16)MSG_CTRL_TYPE_HOST << MSG_CTRL_IDX_GROUP_SHIFT) | 0x0a09,//0x0411
	#endif
	/* unknown msg */ 
...
typedef enum btnMsgList_e {
    ...
    SP1K_MSG_KEY_PRESS_AF_KEY	= ((UINT16)MSG_CTRL_TYPE_BTN << MSG_CTRL_IDX_GROUP_SHIFT) | 0x0115,
	...
	SP1K_MSG_KEY_RELEASE_MAX   	= ((UINT16)MSG_CTRL_TYPE_BTN << MSG_CTRL_IDX_GROUP_SHIFT) | 0x0215,//0x1211~0x12ff
	...
	SP1K_MSG_KEY_REPEATE_MAX   	= ((UINT16)MSG_CTRL_TYPE_BTN << MSG_CTRL_IDX_GROUP_SHIFT) | 0x030e,//0x130a~0x13ff
