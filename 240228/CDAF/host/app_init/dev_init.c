...
void hostDevInit(void)
{
	uiPara_t *pPara;
	UINT16 adcVal = 0;
	UINT8 enterCardUpdateFlag = Flag_false;
	...
	printf("adc val : %d\n", adcVal);
	sp1kHalWait(50);
    if ((adcVal >= (168 - 50) && adcVal <= (168 + 50)))
    {
        enterCardUpdateFlag = Flag_true;
    }
#endif
...
#if 1
	//  微距调试模式 电源键 + AF键
	if ((adcVal >= (400 - 60) && adcVal <= (400 + 45))||(adcVal >= (297 - 50) && adcVal <= (297 + 50)))
    {
		//enterMacroadjust = 1;
	}
#endif

	//if (HAL_GpioByteInGet(HAL_GPIO_BYTE_GEN1, 0x02, 1)) {
    ...
    if (!sp1kUSB_PlugGet())
    {
        ...
        //||(adcVal >= (518 - 30) && adcVal <= (518 + 30)||adcVal >= (400 - 60) && adcVal <= (400 + 60))) {
        if ((adcVal >= (1023 - 40) && adcVal <= (1023 + 40)))
        {
            sp1kHalWait(1000);
            adcVal = sp1kADCValueSnapIntr();
            //||(adcVal >= (518 - 30) && adcVal <= (518 + 30))||adcVal >= (400 - 60) && adcVal <= (400 + 60))) {
	...
	// 开机卡升级
	if (!sp1kSD_CdGet())     // && enterCardUpdateFlag
    {
