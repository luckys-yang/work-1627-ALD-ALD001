...
// 进入自动测试模式
    ...
    case SP1K_MSG_KEY_REPEATE_SNAP: // 【拍照键长按消息】
    {
    ...
    case SP1K_MSG_KEY_RELEASE_SNAP: // 【拍照键松开消息】
    {
        if ((Flag_true == VideoPara.video_af_timer_start) && (Flag_false == VideoPara.video_af_timer_out))
        {
            break;
        }
    }
    case SP1K_MSG_KEY_PRESS_AF_KEY: // 【AF_Key拍照第一段消息】
    {
#if SUPPORT_AUTO_TEST 
...
//}
    ...
    case SP1K_MSG_KEY_PRESS_MENU: // 【MENU键按下】
    {
        ...
        {
            StillPara.play_return_view_Status = PAGE_VIDEO;
...
// sp1kDistDisable();
    ...
    case SP1K_MSG_KEY_PRESS_DOWN:   // 【下键按下消息】
    {
        key_enter_seamless_flag = 0;
        break;
    }

    case SP1K_MSG_KEY_PRESS_UP: // 【上键按下消息】
    {
        key_repeate_check_flag = 0;
        key_enter_seamless_flag = 0;
        break;
    ...
    case SP1K_MSG_KEY_REPEATE_UP:   // 【上键长按消息】
    {
        if (!key_repeate_check_flag)
        {
            key_repeate_check_flag = 1;
            key_enter_seamless_flag = 1;
        }
        break;
    }
    case SP1K_MSG_KEY_PRESS_AF: // 【AF按键按下消息】
    {
        /*进入拍照回放且弹出删除框*/
...
UINT8 appVideoFrmRateSet(void)
{
	...
	sp1kVideoRecParamSet(VD_DUMY_SPACE, 0);
