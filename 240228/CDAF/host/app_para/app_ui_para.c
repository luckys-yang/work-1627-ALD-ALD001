...
/* ------ Note: Demo code zone end flag, don't modify or delete this line!!! ------ */
	...
	else// FW flow
	{
		...
		psPara->SleepTime=POWER_SAVE_3MIN; // min
